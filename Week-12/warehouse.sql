...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2917940370ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=warehouse&table=orders">`warehouse`.`orders`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=warehouse&table=customer">`warehouse`.`customer`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=warehouse&table=items">`warehouse`.`items`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=warehouse&table=warhouses">`warehouse`.`warhouses`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=warehouse&table=stores">`warehouse`.`stores`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=warehouse&table=city">`warehouse`.`city`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="735e732656566d62276b627b4a27705f">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="warehouse" targettable="warhouses">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `warhouses` w INNER JOIN `stores` s ON s.W_id = w.WID;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="warehouse" targettable="warhouses">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `warhouses` w INNER JOIN `stores` s ON s.W_id = w.WID GROUP BY Wname;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="warehouse" targettable="warhouses">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `warhouses` w INNER JOIN `stores` s ON s.W_id = w.WID GROUP BY Wname ORDER BY COUNT(Wname) DESC limit 1;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="warehouse" targettable="warhouses">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `warhouses` w INNER JOIN `stores` s ON s.W_id = w.WID GROUP BY Wname ORDER BY COUNT(Wname) ASC limit 1;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="warehouse" targettable="orders">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `orders`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="warehouse" targettable="items">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `orders` o INNER JOIN `items` i ON Iteam_id = ItemNo;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="warehouse" targettable="items">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `items`  
ORDER BY `items`.`Description` ASC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="warehouse" targettable="items">
                            <div class="action_content">
...
ORDER BY `items`.`Description` ASC</span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `items`  
ORDER BY `items`.`Description`  DESC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="warehouse" targettable="items">
                            <div class="action_content">
...
ORDER BY `items`.`Description`  DESC</span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `orders` o INNER JOIN `items` i ON o.Iteam_id = i.ItemNo;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="warehouse" targettable="orders">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `orders` o INNER JOIN `items` i ON o.Iteam_id = i.ItemNo GROUP BY Description;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="warehouse" targettable="orders">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `orders` o INNER JOIN `items` i ON o.Iteam_id = i.ItemNo GROUP BY Description ORDER BY COUNT(Description) ASC limit 1;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="warehouse" targettable="orders">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `orders` o INNER JOIN `items` i ON o.Iteam_id = i.ItemNo GROUP BY Description ORDER BY COUNT(Description) DESC limit 1;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="warehouse" targettable="orders">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `orders`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="warehouse" targettable="customer">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `orders` o, customer c WHERE o.C_id = c.CNO;</span>
                        </div>
